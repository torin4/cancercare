  ...
  return (
    <div className={combineClasses(DesignTokens.components.modal.backdrop, 'z-50')}>
      <div className={combineClasses('w-full h-full md:h-auto', DesignTokens.borders.radius.lg, 'md:max-w-md md:max-h-[85vh] overflow-hidden flex flex-col animate-slide-up', DesignTokens.components.modal.container)}>
        ...
        <div className={combineClasses('flex-1 overflow-y-auto', DesignTokens.components.modal.body, 'space-y-4', DesignTokens.spacing.gap.lg)}>
          ...
          <div>
            ...
            <p className={combineClasses(DesignTokens.typography.body.xs, 'mt-1', DesignTokens.colors.neutral.text[500])}>Common cancer-related lab metrics or enter your own</p>
          </div>

          {newLabData.label === '' && (
          <div className={combineClasses(DesignTokens.borders.radius.sm, DesignTokens.spacing.card.mobile, 'space-y-3', DesignTokens.spacing.gap.md, DesignTokens.colors.neutral[50])}>
            <h4 className={combineClasses(DesignTokens.typography.h3.weight, DesignTokens.typography.body.sm, DesignTokens.colors.neutral.text[800])}>Custom Lab Metric</h4>

            <div>
              <label className={combineClasses('block', DesignTokens.typography.body.sm, DesignTokens.typography.h3.weight, 'mb-1', DesignTokens.colors.neutral.text[700])}>Lab Name *</label>
              <input
                type="text"
            ...
            <div className={combineClasses('grid grid-cols-2', DesignTokens.spacing.gap.md)}>
              <div>
                <label className={combineClasses('block', DesignTokens.typography.body.sm, DesignTokens.typography.h3.weight, 'mb-1', DesignTokens.colors.neutral.text[700])}>Normal Range *</label>
                <input
                  type="text"
              ...
              <div>
                <label className={combineClasses('block', DesignTokens.typography.body.sm, DesignTokens.typography.h3.weight, 'mb-1', DesignTokens.colors.neutral.text[700])}>Unit *</label>
                <input
                  type="text"
            ...
            <div className={combineClasses(DesignTokens.borders.radius.sm, DesignTokens.spacing.iconContainer.mobile, DesignTokens.components.alert.info.bg, DesignTokens.components.alert.info.border)}>
              <p className={combineClasses(DesignTokens.typography.body.xs, DesignTokens.components.alert.info.textSecondary)}>
          ...
          {newLabData.label && newLabData.normalRange && newLabData.unit && (
            <div className={combineClasses(DesignTokens.borders.divider, 'pt-4', DesignTokens.spacing.header.mobile)}>
              <h4 className={combineClasses(DesignTokens.typography.h3.weight, DesignTokens.typography.body.sm, 'mb-3', DesignTokens.colors.neutral.text[800])}>Add Initial Value (Optional)</h4>
              <p className={combineClasses(DesignTokens.typography.body.xs, 'mb-3', DesignTokens.colors.neutral.text[600])}>You can add your first lab value now, or add it later from the Health tab.</p>
              
              <div className={combineClasses('grid grid-cols-2', DesignTokens.spacing.gap.md)}>
                <div>
                  <label className={combineClasses('block', DesignTokens.typography.body.sm, DesignTokens.typography.h3.weight, 'mb-1', DesignTokens.colors.neutral.text[700])}>Value</label>
                  <input
                    type="number"
                    step="any"
          ...
          {newLabData.label && newLabData.normalRange && newLabData.unit && (
            <div className={combineClasses(DesignTokens.borders.radius.sm, DesignTokens.spacing.card.mobile, DesignTokens.components.alert.success.bg, DesignTokens.components.alert.success.border)}>
              <p className={combineClasses(DesignTokens.typography.body.xs, DesignTokens.typography.h3.weight, 'mb-1', DesignTokens.components.alert.success.text)}>Preview:</p>
              <p className={combineClasses(DesignTokens.typography.body.sm, DesignTokens.components.alert.success.textSecondary)}>
        ...
        <div className={combineClasses('flex-shrink-0 border-t', DesignTokens.components.modal.footer, DesignTokens.colors.neutral.border[200])}>
          <div className={combineClasses('flex', DesignTokens.spacing.gap.md)}>
            <button
              onClick={handleCancel}
              className={combineClasses('flex-1 py-2.5', DesignTokens.borders.radius.sm, DesignTokens.typography.h3.weight, DesignTokens.transitions.default, DesignTokens.components.button.secondary)}
            >
              Cancel
            </button>
            <button
