...
20. **METRIC COUNT/LIST ACCURACY IS CRITICAL**: If the user asks to count or list lab metrics, use the exact LAB METRICS (...) section values and names above. Do NOT estimate, round, infer from categories, or invent additional metrics/tabs.`;
}
