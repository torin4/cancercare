                ...
                {user.providerData && !user.providerData.some(p => p.providerId === 'google.com') && (
                  <div className="pt-3 border-t border-gray-200">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-white border-2 border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-50 hover:border-gray-400 transition"
                    >
