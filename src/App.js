...
import { documentService, patientService, emergencyContactService, symptomService, trialLocationService } from './firebase/services';
import { processDocument, linkValuesToDocument } from './services/documentProcessor';
...
import { getWeightNormalRange } from './utils/healthUtils';
import { labKeyMap } from './utils/normalizationUtils';
      ...
      <div className="min-h-screen bg-medical-neutral-50 flex items-center justify-center">
        <div className="text-center">
          <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
            <img src={logoLightBg} alt="CancerCare" className="w-16 h-16" />
          </div>
      ...
      <div className={`flex-1 overflow-y-auto pb-20 md:pb-0 transition-all duration-300 ${
        ...
        {labTooltip && (
          <>
            ...
            />
            {/* Tooltip - slides up like quick action modals */}
            <div
            ...
            >
              <div className="w-full bg-white rounded-xl shadow-2xl border border-medical-neutral-200 p-5 animate-slide-up overflow-y-auto max-h-[80vh]">
